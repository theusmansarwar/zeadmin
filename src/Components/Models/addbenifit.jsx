...
import { addBenifit, addProcess, addService, createnewRole } from "../../DAL/create";
import { updateBenifit, updateProcess, updateRole, updateSubService } from "../../DAL/edit";
...
export default function AddBenifit({ open, setOpen, Modeltype, Modeldata, onResponse }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Modeltype === "Add") {
      ...
      response = await addBenifit(formData);
    } else {
      formData.append("serviceId", id);
      formData.append("benifitId", subid);
      response = await updateBenifit(formData);
    }
