...
import { addService, createnewRole } from "../../DAL/create";
import { updateRole, updateSubService } from "../../DAL/edit";
...
export default function AddServices({ open, setOpen, Modeltype, Modeldata, onResponse }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Modeltype === "Add") {
      ...
      response = await updateSubService(formData);
    }
